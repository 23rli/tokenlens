...
- Passive Copilot chat-session capture plus a manual "Score this prompt" command.
- Success-metrics dashboard: token reduction, waste reduction, prompt-quality
  improvement, average score increase, coaching engagement, and sustainability
  impact.

...
const STATE_KEY = 'ecoprompt.guardianState.v1';
...
/**
 * Single source of truth for guardian/ecosystem state. Persists to globalState,
...
export class GuardianStore {
  private readonly _onDidChange = new vscode.EventEmitter<GuardianState>();
  ...
  constructor(private readonly context: vscode.ExtensionContext) {
    this.data = context.globalState.get<PersistShape>(STATE_KEY) ?? GuardianStore.empty();
    this._captureEnabled = vscode.workspace
      .getConfiguration('ecoprompt.passiveCapture')
